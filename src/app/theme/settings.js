...
$(function () {
    ...
    window.Scaffold = {
        ...
        isScreen: function isScreen(size) {
        ...
        lighten: function lighten(color, ratio) {
            return this.changeColor(color, ratio, false);
        },
        darken: function darken(color, ratio) {
            return this.changeColor(color, ratio, true);
        }
    };

    var ScaffoldSettingsBundle = function ScaffoldSettingsBundle() {
        var defaultSettings = {
            /**
