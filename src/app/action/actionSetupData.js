...
exports.getActionSetupData = getActionSetupData;
exports.setActionType = setActionType;
exports.setActionName = setActionName;
exports.setActionTimeout = setActionTimeout;
exports.setActionIP = setActionIP;
exports.setActionAPIServer = setActionAPIServer;
...
function getActionSetupData(action) {
  if (!_.isUndefined(action.setupData) && !_.isEmpty(action.setupData)) {
    exports.data = data = action.setupData;
  } else {
...
function setActionIP() {
  data.action.ip = $("#k8s-ip").val();
}

function setActionAPIServer() {
