...
var historyListDataService = _interopRequireWildcard(_historyList);
...
function initSequenceView() {
    $.ajax({
        ...
        success: function success(data) {
            ...
            // .on("touchmove", nozoom)
            .append("svg").attr("width", constant.svgWidth).attr("height", constant.svgHeight).style("fill", "white");
            ...
            constant.sequenceLinesView = g.append("g").attr("width", constant.svgWidth).attr("height", constant.svgHeight).attr("id", "sequenceLinesView");

            constant.sequenceActionsView = g.append("g").attr("width", constant.svgWidth).attr("height", constant.svgHeight).attr("id", "sequenceActionsView");

            constant.sequencePipelineView = g.append("g").attr("width", constant.svgWidth).attr("height", constant.svgHeight).attr("id", "sequencePipelineView");
